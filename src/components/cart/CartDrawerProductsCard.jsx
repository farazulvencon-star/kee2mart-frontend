...
const CartDrawerProductsCard = ({ product, cartProductsData, setCartProductsData, showPrescriptionSelect = false }) => {
    ...
    const handleRemoveItem = async () => {
        ...
        dispatch(removeProductFromPrescriptions({ productId: product?.product_variant_id }))
    }
