                    ...
                    <div className="text-base font-normal text-start">
                        {
                            product?.discounted_price ?
                                <div>
                                    {setting?.currency}{formatPriceDisplay(product?.discounted_price)} <span className='line-through'>{setting?.currency}{formatPriceDisplay(product?.price)} </span>
                                </div> :
                                <div>{setting?.currency}{formatPriceDisplay(product?.price)}</div>
                        }
                    </div>
                </div>
            </div>
