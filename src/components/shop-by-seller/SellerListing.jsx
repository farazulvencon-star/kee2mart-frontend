...
const SellerListing = () => {
    ...
    // A user module switch invalidates this module's sellers → go home.
    ...
    return (
        <section>
            ...
            <div className='container'>
                <div className={`grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 gap-2 h-auto my-5 px-2`}>
                    {
