              ...
              <div className="flex gap-2 items-center justify-start md:justify-center">
                ...
                <div className="flex items-center">
                  <LocalizedLink
                    ...
                    className=" flex items-center gap-2 py-2 px-3  cardBorder rounded-sm font-medium text-base hover:primaryBackColor hover:text-white"
                  >
                    {t("view_details")} <FaArrowRight />
                  </LocalizedLink>
                </div>
              </div>
            </div>
