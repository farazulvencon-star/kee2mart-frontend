        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-grow">
            <div className="flex items-center justify-between ">
              ...
              <button
                disabled={coupon?.is_applicable == 0}
                className="px-4 py-1 border cardBorder rounded-md text-sm hover:primaryBackColor transition-colors hover:text-white disabled:text-gray-400 disabled:bg-transparent"
